...
public class Animal implements org.apache.thrift.TBase<Animal, Animal._Fields>, java.io.Serializable, Cloneable, Comparable<Animal> {
  ...
  private static final org.apache.thrift.protocol.TField VACCINATED_FIELD_DESC = new org.apache.thrift.protocol.TField("vaccinated", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  public boolean vaccinated; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    NAME((short)1, "name"),
    TYPE((short)2, "type"),
    VACCINATED((short)3, "vaccinated");
  ...
  private static final int __VACCINATED_ISSET_ID = 0;
  ...
  static {
    ...
    tmpMap.put(_Fields.TYPE, new org.apache.thrift.meta_data.FieldMetaData("type", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.VACCINATED, new org.apache.thrift.meta_data.FieldMetaData("vaccinated", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public Animal setType(java.lang.String type) {
    this.type = type;
    return this;
  }
  ...
  public void unsetVaccinated() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __VACCINATED_ISSET_ID);
  }

  /** Returns true if field vaccinated is set (has been assigned a value) and false otherwise */
  public boolean isSetVaccinated() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __VACCINATED_ISSET_ID);
  }

  public void setVaccinatedIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __VACCINATED_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case VACCINATED:
      if (value == null) {
        ...
        setVaccinated((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(Animal that) {
    ...
    boolean this_present_vaccinated = true;
    boolean that_present_vaccinated = true;
    if (this_present_vaccinated || that_present_vaccinated) {
      if (!(this_present_vaccinated && that_present_vaccinated))
        return false;
      if (this.vaccinated != that.vaccinated)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((vaccinated) ? 131071 : 524287);
  ...
  public int compareTo(Animal other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetVaccinated()).compareTo(other.isSetVaccinated());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVaccinated()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.vaccinated, other.vaccinated);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("Animal(");
    boolean first = true;
  ...
  private static class AnimalStandardScheme extends org.apache.thrift.scheme.StandardScheme<Animal> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // VACCINATED
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.vaccinated = iprot.readBool();
              struct.setVaccinatedIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Animal struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(VACCINATED_FIELD_DESC);
      oprot.writeBool(struct.vaccinated);
      oprot.writeFieldEnd();
